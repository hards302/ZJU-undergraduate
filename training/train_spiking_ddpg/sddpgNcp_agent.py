...
from training.train_spiking_ddpg.sddpg_networks import ActorNetSpikingwithNCP


class NcpAgentSpiking:
    """
    ...
    def __init__(self,
        ...
        """
        self.actor_net = ActorNetSpikingwithNCP(self.spike_state_num, self.action_num, self.device,
                                         inter_num=ncp_net_dim[0],
                                         command_num=ncp_net_dim[1],
        ...
        self.target_actor_net = ActorNetSpikingwithNCP(self.spike_state_num, self.action_num, self.device,
                                                inter_num=ncp_net_dim[0],
                                                command_num=ncp_net_dim[1],
                                                batch_window=self.batch_window)
    ...
    def save(self, save_dir, episode, run_name):
        ...
        pickle.dump([l1_weights, l2_weights, l3_weights, l4_weights],
                    open(save_dir + '/' + run_name + '_ncp_weights_s' + str(episode) + '.p', 'wb+'))
        pickle.dump([l1_bias, l2_bias, l3_bias, l4_bias],
                    open(save_dir + '/' + run_name + '_ncp_bias_s' + str(episode) + '.p', 'wb+'))
